  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.diagram}>
        ...
        {/* HOUSE (White) */}
        <div style={{...styles.node, top: '55%', left: '50%', transform: 'translate(-50%, -50%)', zIndex: 10, borderColor: COLORS.white}}>
          <span style={styles.icon}>🏠</span>
        ...
        <div style={{...styles.node, top: '55%', right: '10%', transform: 'translateY(-50%)', borderColor: data.battery_level > 20 ? COLORS.blue : COLORS.danger}}>
          <span style={styles.icon}>🔋</span>
        ...
        <svg style={styles.svg}>
          {isSolarProducing && <line x1="50%" y1="18%" x2="50%" y2="42%" stroke={COLORS.orange} strokeWidth="4" className="flow-line" />}
          {isGridImporting && <line x1="20%" y1="55%" x2="40%" y2="55%" stroke={COLORS.blue} strokeWidth="4" className="flow-line" />}
          {isGridExporting && <line x1="40%" y1="55%" x2="20%" y2="55%" stroke={COLORS.orange} strokeWidth="4" className="flow-line-reverse" />}
          {isBatteryDischarging && <line x1="80%" y1="55%" x2="60%" y2="55%" stroke={COLORS.orange} strokeWidth="4" className="flow-line-reverse" />}
          {isBatteryCharging && <line x1="60%" y1="55%" x2="80%" y2="55%" stroke={COLORS.blue} strokeWidth="4" className="flow-line" />}
        </svg>
      </div>
